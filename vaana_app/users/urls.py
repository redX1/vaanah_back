...
from .views import (
    LoginAPIView, PasswordTokenCheckAPI, RegistrationAPIView, RequestPasswordResetEmail, SetNewPasswordAPIView, UserRetrieveUpdateAPIView, VerifyEmail, UserStoreAPIView, UserAPIView
)
